// Research tree with technologies for each era
...
export function getTechsByEra(era: string): Technology[] {
  return TECHNOLOGIES.filter(tech => tech.era === era);
}

export function canResearch(techId: string, researchedTechs: Set<string>, science: number): boolean {
